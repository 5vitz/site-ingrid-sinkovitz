...
export const servicesData: ServiceItem[] = [
  {
    ...
    description: "Definição dos pilares estruturais e da essência da comunicação da marca.",
    bullets: [
  ...
  },
  {
    ...
    description: "Alinhamento operacional para garantir a entrega e a consistência das peças.",
    bullets: [
